            ...
            httpGet(url) {resp ->
                ...
                if (resp.status==200){
                    ...
                    if( resp.data.list[1].pm10_value )
                    {
                        ...
                        sendEvent(name: "pm10_value", value: resp.data.list[1].pm10Value as Integer, unit: "¥ìg/m©ø", isStateChange: true)
                    }
                    else
                    ...
                    { 
                        ...
                        sendEvent(name: "pm25_value", value: resp.data.list[1].pm25Value as Integer, unit: "¥ìg/m©ø", isStateChange: true)
                    }
                    else
